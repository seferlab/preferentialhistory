...
val_map = {anchor: 'yellow',
           dup: 'tan'}

values = [val_map.get(node,col) for node in G.nodes()]
...
nx.draw(G, pos, with_labels=True, node_size=2500, node_color=values, font_size=30, font_weight='bold')
